...
# Load homework and exam file, make a dataframe
...
# Merge exam grades and quiz grades
...
# Calculate average and total homework scores
...
final_data["Quiz Scores"] = final_data[
...
# Map each grade to each key in the series
